// Preset: Aether Soft (moved out of diffusion.js)
// Registers a factory which returns the inking function using internal Fluid API
(function(){
  ...
  registerFluidPreset('Aether Soft', factory);
})();
